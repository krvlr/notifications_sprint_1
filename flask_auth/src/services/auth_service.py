...
class AuthService:
    ...
    def refresh(self, user: User, device_info: str, refresh_jti: str) -> dict:
        self.check_jwt_status(user_id=str(user.id), jti=refresh_jti, ex=AccountRefreshException)
    ...
    def password_change(
        ...
        self.check_jwt_status(
            user_id=str(user.id), jti=access_jti, ex=AccountPasswordChangeException
        )
    ...
    def signout(self, user_id: str, refresh_jti: str, access_jti: str):
        self.check_jwt_status(user_id=user_id, jti=access_jti, ex=AccountSignoutException)
    ...
    def signout_all(
        ...
        self.check_jwt_status(user_id=user_id, jti=access_jti, ex=AccountSignoutAllException)
    ...
    def history(
        ...
        self.check_jwt_status(user_id=user_id, jti=access_jti, ex=AccountHistoryException)
