...
def signin():
    try:
        ...
        response = jsonify(BaseResponse(data=auth_data.dict()).dict())
...
def refresh():
    try:
        ...
        response = jsonify(BaseResponse(data=auth_data).dict())
...
def signout():
    ...
    except AccountSignoutException as ex:
        return (
            jsonify(BaseResponse(success=False, error=ex.error_message).dict()),
            HTTPStatus.BAD_REQUEST,
        )
...
def signout_all():
    try:
        ...
        return jsonify(BaseResponse().dict()), HTTPStatus.OK
    except AccountSignoutAllException as ex:
        return (
            jsonify(BaseResponse(success=False, error=ex.error_message).dict()),
            HTTPStatus.BAD_REQUEST,
        )
...
def history():
    ...
    except AccountHistoryException as ex:
        return (
            jsonify(BaseResponse(success=False, error=ex.error_message).dict()),
            HTTPStatus.BAD_REQUEST,
        )
